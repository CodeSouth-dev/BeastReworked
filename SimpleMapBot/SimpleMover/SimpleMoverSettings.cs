...
{
    public class SimpleMoverSettings : JsonSettings
    {
        private static SimpleMoverSettings _instance;
        
        /// <summary>The current instance for this class.</summary>
        public static SimpleMoverSettings Instance
        {
            get { return _instance ?? (_instance = new SimpleMoverSettings()); }
        }

        /// <summary>The default ctor. Will use the settings path "BeastMover".</summary>
        public SimpleMoverSettings()
